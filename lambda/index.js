...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'This is the ultimate calculator. Give me numbers and I will do the magic';
...
const MinusIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'MinusIntent';
    },
    ...
    handle(handlerInput) {
        ...
        if (firstNumber && secondNumber) {
            let result = parseInt(firstNumber) - parseInt(secondNumber)
            speechText = `${firstNumber} minus ${secondNumber} is ${result}`
...
const DivideIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if (firstNumber && secondNumber) {
            let result = parseInt(firstNumber) / parseInt(secondNumber)
            speechText = `${firstNumber} divided by ${secondNumber} is ${result}`
